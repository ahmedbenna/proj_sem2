...
export default function EditProfilePassenger() {
    ...
    async function changePass() {
        try {
            const response = await axios.put('http://localhost:8088/provider/editPassword/' + idp, passData);
            console.log(response);
        } catch (error) {
            console.error(error);
        }
                                ...
                                <Grid item>
                                    <Formik
                                        ...
                                        onSubmit={async (values) => {
                                            ...
                                            await axios.put('http://localhost:8088/client/editClient/' + idp, {
                                                email: values.email,
                                                firstName: values.firstName,
                                                lastName: values.lastName,
                                                phone: values.phone,
